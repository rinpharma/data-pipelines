...
```{r}
#readr::read_delim(
#  "https://rinpharma.github.io/data-pipelines/output/processed_proceedings.parquet", delim = ";",
...
```{r}
#readr::read_delim(
#  "https://rinpharma.github.io/data-pipelines/output/processed_team.parquet", delim = ";",
#  show_col_types = FALSE) |>
#  dplyr::glimpse()
```
