...
```{r}
readr::read_delim(
  "https://rinpharma.github.io/data-pipelines/output/processed_proceedings.csv", delim = ";",
...
```{r}
readr::read_delim(
  "https://rinpharma.github.io/data-pipelines/output/processed_team.csv", delim = ";",
  show_col_types = FALSE) |>
  dplyr::glimpse()
```
